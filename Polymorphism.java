public class Polymorphism {
    public static void main(String[] args) {
        ...
        f1.run();               //Compile time Polymorphism because it checking method during compile time
        f1.run(25);       //Compile time Polymorphism

        s1.run();               //Run time Polymorphism because it checking method during run time
